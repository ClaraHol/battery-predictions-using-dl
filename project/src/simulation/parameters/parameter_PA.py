...
# Specific parameters
capa_used = 73.36  # Discharge or charge capacity at the target cycle number (i.e. cycle 1) [Ah], take the minimal value of all similar cells.
# Nominal capacity
capa_nom = 74.273  # rated capacity [Ah], useless but necessary
...
def anode_ocp(sto):  # p32-523-anode, 0-0.93984
    ...
    u_eq = (
        a1
        + a2 * pybamm.exp(a3 * sto)
        + b1 * pybamm.exp(b2 * sto)
        + c1 * pybamm.exp(c2 * sto + c3)
...
def cathode_ocp(sto):  # p73-cathode-0.19 0.94
    a1 = -1.52249174e01
    a2 = 5.12426111e-03
    b1 = 2.64167681e01
    b2 = -5.29038333e00
