...
# Specific parameters
capa_used = 71.66  # Discharge or charge capacity at the target cycle number (i.e. cycle 1) [Ah], take the minimal value of all similar cells.
# Nominal capacity
capa_nom = 76  # rated capacity [Ah], useless but necessary
