...
DATA_ROOT = Path("/work3/claho/battery_datasets/processed/pouch_cells")
...
for cell_id, group in data.groupby("cell_id"):
    ...
    ax.set_ylim(group["voltage_V"].min() - 0.05, group["voltage_V"].max() + 0.15)
