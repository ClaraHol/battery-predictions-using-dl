...
# Specific parameters
capa_used = 2.2498  # Discharge or charge capacity at the target cycle number (i.e. cycle 1) [Ah], take the minimal value of all similar cells.
# Nominal capacity
...
def anode_ocp(sto):  # SiOx TUM anode, 0 - 364.11/406 , discharge
...
def cathode_ocp(sto):  # NCA TUM cathode, 0 - 167.414/280 , discharge
