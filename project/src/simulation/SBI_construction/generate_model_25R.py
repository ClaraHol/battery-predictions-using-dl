...
inference = NPE(
    show_progress_bars=True, prior=prior, density_estimator=nde_nsf, device=device
)
inference = inference.append_simulations(
    theta_tra, x_tra, proposal=prior, data_device=device
)
...
if __name__ == "__main__":
    ...
    fig, axes = plot_summary(
        inference, tags=["training_loss", "validation_loss"], figsize=(10, 4)
    )
